...
along the interface between two subsurface materials, with energy from the refracted wave eventually returning to the surface. These two phenomena give rise to the two main techniques of applied seismology: reflection surveying and refraction surveying.
...
In the following parts of our seismic section  we provide background to the fundamental physics that underly all seismic methods and then investigate the refraction and reflection methods. Other seismic methods exist as well, such as the MASW method, but discussing them is out of the scope of our course. If you are interested, you can find more information from the original textbook `here`_. **Please note that this link will take you outside of this textbook and into another textbook that looks very similar but is differently organized**.

.. _here: https://gpg.geosci.xyz/content/seismic/MASW.html
