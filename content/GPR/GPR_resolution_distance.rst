...
From the seven step framework  :ref:`foundations_sevensteps` you learned how important it is to assess whether a survey will be successfull before collecting data in the field. In this section you will learn how to determine what GPR system to use in which situation and what size of structure you can expect to resolve.
